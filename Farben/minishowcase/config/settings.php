 ...
 */
	 ...
	 * VALUES: [ <text> ]
	 */
	$settings['gallery_title'] = 'Farben Photo Gallery';
	
	
	/* width of gallery container
	 * VALUES: [ <number (pixels)> ] */
	$settings['gallery_width'] = 900;
	...
	$settings['gallery_default_name'] = 'scroll';
	 ...
	 * NOTE: IT DOES NOT WORK WITH GALLERY NAMES THAT CONTAIN SPACES */
	$settings['show_permalink'] = false; /* BETTER NOT TO USE IT YET */
	 ...
	 * any single quote */
	$settings['gallery_footer'] = 'Copyright &copy; 2010 BGRW. All rights reserved. ';
	 ...
	 * VALUES: [ true | false ] */
	$settings['show_thumb_number'] = true;
